                ...
                <div class="card-body px-0 pt-0 pb-2">
                    ...
                    <form action="{{ route('update-org', $organizer->id_organizers) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="email" name="email" value="{{ $organizer->email }}" required>
                        </div>
                        <div class="form-group">
                            <label for="phone">phone:</label>
                            <input type="text" class="form-control" id="phone" name="phone" value="{{ $organizer->phone }}" required>
                        </div>
