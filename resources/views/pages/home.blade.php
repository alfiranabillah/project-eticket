...
<div class="container mt-5 d-flex justify-content-evenly flex-wrap ">
      ...
      <div class="card cardcustom-upc mb-3 ">
         <div class="d-flex">
            <div class="col-lg-6 col-md-4 my-5 ms-5">
               <img src="/frontend/images/sakuraa.jpeg" class="img-fluid rounded-start " style="width: 500px; " alt="...">
            </div>
            <div class="col-md-8 mt-5">
               <div class="card-body ms-2"style="margin-top: 50px;">
                  <h5 class="card-title-upc">Sakura Festival</h5>
                  <p class="btn btn-second-upc">10 Februari 2025</p>
                  <div class="d-flex">
   ...
   <div class="heder">
      ...
      <div class="card cardcustom" style="width: 270px;">
         <img src="/frontend/images/hiphop.jpeg" class="card-img-top" style="width: 270px; margin-top: -5px;" alt="...">
         <div class="card-body">
            <div class="card-text d-flex justify-content-between">
               <p class="btn btn-second">23 Jan 2025</p>
               <p class="mt-2"><img src="/frontend/images/tickets.png" alt="">
               <p class="fw-bold mt-2 my-auto">75.000</p>
            </div>
            <h5 class="card-title">Gunadarma Werehouse Project</h5>
         </div>
      </div>
   </div>
   <div class="heder">
      ...
      <div class="card cardcustom" style="width: 270px;">
         <img src="/frontend/images/digitalmar.jpeg" class="card-img-top " style="width: 270px; margin-top: -5px;" alt="...">
         <div class="card-body">
            <div class="card-text d-flex justify-content-between" style="margin-top: -10px;">
               <p class="btn btn-second" >31 Jan 2025</p>
               <p><img src="/frontend/images/tickets.png" alt="">
               <p class="fw-bold mt-1 my-auto">50.000</p>
            </div>
            <h5 class="card-title">Seminar Teknologi AI</h5>
         </div>
      </div>
   </div>
</div>
<div class="container noraebang my-4">
   ...
   <div class="desc-norebang d-flex mb-4 justify-content-between">
      <div class="deskripsi col-lg-8">
         <p style="margin-left: 20px; font-size: 19px;">Wajib hadir! Event yang lagi trending abis ini bakal kasih kamu pengalaman tak terlupakan! 🌈</p>
      </div>
...
<div class="container noraebang my-4">
   ...
   <div class="desc-norebang d-flex mb-4 justify-content-between">
      <div class="deskripsi col-lg-8">
         <p style="margin-left: 20px; font-size: 19px;">Jangan sampai ketinggalan! Event paling ditunggu-tunggu sebentar lagi hadir buat kamu! 🎉</p>
      </div>
      <div class="btn-view-more">
         @guest
         <a class="btn btn-primer" type="button" onclick="showAlert()">Selengkapnya</a>
